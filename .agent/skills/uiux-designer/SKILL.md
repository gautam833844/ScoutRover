...
- **`search.py`**: Queries local design data to compile custom theme sheets.
  - Usage: `python3 .agent/skills/uiux-designer/scripts/search.py <query> [--design-system] [--domain <domain>] [--stack <stack>]`